...
namespace user_stuff_share_app.Migrations
{
    ...
    [Migration("20211028160502_FlagDB")]
    partial class FlagDB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ssa_database.Models.Flag_Models.Flag", b =>
                {
                    ...
                    b.Property<JsonDocument>("Status")
                        .HasColumnType("jsonb")
                        .HasColumnName("status");
            ...
            modelBuilder.Entity("ssa_database.Models.Flag_Models.Flagger", b =>
                {
                    b.Property<long>("FlaggerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("FlagId")
                        .HasDatabaseName("ix_flagger_flag_id");
            ...
            modelBuilder.Entity("ssa_database.Models.Flag_Models.Flagger", b =>
                {
                    b.HasOne("ssa_database.Models.Flag_Models.Flag", null)
                        .WithMany("Flaggers")
                        .HasForeignKey("FlagId")
                        .HasConstraintName("fk_flagger_flag_flag_id");
                });
